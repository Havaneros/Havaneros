        ...
        class DOPBSPBackEndCalendarAvailability extends DOPBSPBackEndCalendar{
            ...
            function set_default($id,
                ...
                if (count($schedule) == 0){
                    ...
                    $wpdb->update($DOPBSP->tables->calendars, array('default_availability' => json_encode($schedule)), array('id' => $id));
                }
            ...
            function setDays($id,
                ...
                foreach($days as $day) {
                    ...
                    if (!array_key_exists($day, $days_data)) {
                        $day_split = explode('-',$days_data[$day]['day']);
                        $days_data[$day] = new stdClass();
                        $days_data[$day]->day = $day;
                        $days_data[$day]->year = $day_split[0];
                        $days_data[$day]->price_min = $default_availability->promo == 0 ? $default_availability->price:$default_availability->promo;
                        $days_data[$day]->price_max = $default_availability->promo == 0 ? $default_availability->price:$default_availability->promo;
                        $days_data[$day]->data = json_encode($default_availability);
                    }
                }
