...
*/
    ...
    if (!class_exists('DOPBSPDatabase')){
        class DOPBSPDatabase{
             ...
             * Private variables.
             */
            private $db_version = 2.36;
            private $db_version_api_keys = 1.0;
            private $db_version_calendars = 1.01;
            ...
            function init(){
                ...
                if ($this->db_version != (float)$current_db_version){
                    ...
                    $sql_calendars = "CREATE TABLE ".$DOPBSP->tables->calendars." (
                                            ...
                                            default_availability VARCHAR(1024) DEFAULT '".$this->db_config->calendars['default_availability']."' COLLATE ".$this->db_collation." NOT NULL,
...
// Configuration
            ...
            function config($db_config){
                ...
                $db_config->calendars = array('user_id' => 0,
                                              ...
                                              'address_alt_en' => '',
                                              'coordinates' => '',
                                              'default_availability' => '{"available":1,"bind":0,"hours":{},"hours_definitions":[{"value":"00:00"}],"info":"","notes":"","price":0,"promo":0,"status":"unavailable"}');
