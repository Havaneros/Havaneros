...
(function($){
    $.fn.DOPBSPCalendar = function(options){
        ...
        var Data = {'AddLastHourToTotalPrice': true,
                    ...
                    'ID': 0,
                    'DefaultSchedule': {"available":1,"bind":0,"hours":{},"hours_definitions":[{"value":"00:00"}],"info":"","notes":"","price":0,"promo":0,"status":"unavailable"},
        ...
        methods = {            
             ...
             */    
                ...
                ID = Data['ID'];
                DefaultSchedule = JSON.parse(Data['DefaultSchedule']);
...
// Days                    
        methods_day = {
             ...
             */ 
                return {"available": DefaultSchedule['available'],
                        "bind": 0,
                        "info": DefaultSchedule['info'],
                        "hours_definitions": DefaultSchedule['hours_definitions'],
                        "hours": DefaultSchedule['hours'],
                        "notes": DefaultSchedule['notes'],
                        "price": DefaultSchedule['price'], 
                        "promo": DefaultSchedule['promo'],
                        "status": DefaultSchedule['status']};
            },
            customize:function(){
            /*
...
// Hours
        methods_hours = {
             ...
             */    
                ...
                } else if(DefaultSchedule !== undefined){
                    hoursDef = DefaultSchedule['hours_definitions'];
                }
        ...
        methods_hour = {
             ...
             * @return JSON with default data
             */ 
                return {"available": DefaultSchedule['hours'] !== undefined && DefaultSchedule['hours'][hour] !== undefined ? DefaultSchedule['hours'][hour]['available']:0,
                        "bind": 0,
                        "info": DefaultSchedule['hours'] !== undefined && DefaultSchedule['hours'][hour] !== undefined ? DefaultSchedule['hours'][hour]['info']:"",
                        "notes": DefaultSchedule['hours'] !== undefined && DefaultSchedule['hours'][hour] !== undefined ? DefaultSchedule['hours'][hour]['notes']:"",
                        "price": DefaultSchedule['hours'] !== undefined && DefaultSchedule['hours'][hour] !== undefined ? DefaultSchedule['hours'][hour]['price']:0, 
                        "promo": DefaultSchedule['hours'] !== undefined && DefaultSchedule['hours'][hour] !== undefined ? DefaultSchedule['hours'][hour]['promo']:0,
                        "status": DefaultSchedule['hours'] !== undefined && DefaultSchedule['hours'][hour] !== undefined ? DefaultSchedule['hours'][hour]['status']:"none"};
            },
            events:function(){
            /*
        ...
        methods_form = {
             ...
             */    
                ...
                if ((type === 'days' && !HoursEnabled) 
                    ...
                    HTML.push('             <option value="available" '+(defaultAvailability && DefaultSchedule !== undefined ? (HoursEnabled ? '':(DefaultSchedule['status'] === 'available' ? 'selected="selected"':'')):'')+'>'+StatusAvailableText+'</option>');
                    HTML.push('             <option value="booked" '+(defaultAvailability && DefaultSchedule !== undefined ? (HoursEnabled ? '':(DefaultSchedule['status'] === 'booked' ? 'selected="selected"':'')):'')+'>'+StatusBookedText+'</option>');
                    HTML.push('             <option value="special" '+(defaultAvailability && DefaultSchedule !== undefined ? (HoursEnabled ? '':(DefaultSchedule['status'] === 'special' ? 'selected="selected"':'')):'')+'>'+StatusSpecialText+'</option>');
                    HTML.push('             <option value="unavailable" '+(defaultAvailability && DefaultSchedule !== undefined ? (HoursEnabled ? '':(DefaultSchedule['status'] === 'unavailable' ? 'selected="selected"':'')):'')+'>'+StatusUnavailableText+'</option>');
                    HTML.push('         </select>');
                    HTML.push('     </div>');     
                    HTML.push('     <div class="dopbsp-input-wrapper">');
                    HTML.push('         <label for="DOPBSP-price">'+PriceLabel+' '+Currency+'</label>');
                    HTML.push('         <input type="text" name="DOPBSP-price" id="DOPBSP-price" value="'+(defaultAvailability && DefaultSchedule !== undefined ? (HoursEnabled ? '':DefaultSchedule['price']):'')+'" />');
                    HTML.push('     </div>');                        
                    HTML.push('     <div class="dopbsp-input-wrapper">');
                    HTML.push('         <label for="DOPBSP-promo">'+PromoLabel+' '+Currency+'</label>');
                    HTML.push('         <input type="text" name="DOPBSP-promo" id="DOPBSP-promo" value="'+(defaultAvailability && DefaultSchedule !== undefined ? (HoursEnabled ? '':DefaultSchedule['promo'] > 0 ? DefaultSchedule['promo']:''):'')+'" '+(defaultAvailability && DefaultSchedule !== undefined ? (HoursEnabled ? '':DefaultSchedule['promo'] > 0 ? '':'disabled="disabled"'):'disabled="disabled"')+' />');
                    HTML.push('     </div>');
                    HTML.push('     <div class="dopbsp-input-wrapper">');
                    HTML.push('         <label for="DOPBSP-available">'+AvailableLabel+'</label>');
                    HTML.push('         <input type="text" name="DOPBSP-available" id="DOPBSP-available" value="'+(defaultAvailability && DefaultSchedule !== undefined ? (HoursEnabled ? 1:DefaultSchedule['available']):1)+'" />');
                    HTML.push('     </div>');
                }
                HTML.push('     <div class="dopbsp-input-wrapper">');
                HTML.push('         <label class="dopbsp-for-textarea" for="DOPBSP-info">'+InfoLabel+'</label>');
                HTML.push('         <textarea name="DOPBSP-info" id="DOPBSP-info" rows="5" cols="">'+(defaultAvailability && DefaultSchedule !== undefined ? (HoursEnabled ? '':DefaultSchedule['info']):'')+'</textarea>');  
                HTML.push('     </div>');
                HTML.push('     <div class="dopbsp-input-wrapper">');
                HTML.push('         <label class="dopbsp-for-textarea" for="DOPBSP-notes">'+NotesLabel+'</label>');
                HTML.push('         <textarea name="DOPBSP-notes" id="DOPBSP-notes" rows="5" cols="">'+(defaultAvailability && DefaultSchedule !== undefined ? (HoursEnabled ? '':DefaultSchedule['notes']):'')+'</textarea>'); 
                HTML.push('     </div>');  
                ...
                if (type === 'days'){
                        ...
                        if (Schedule[key] !== undefined){
                            ...
                            for (i=0; i<Schedule[key]['hours_definitions'].length; i++){
                                ...
                                if ((HoursIntervalEnabled 
                                    ...
                                    hoursValue[Schedule[key]['hours_definitions'][i]['value']] = methods_hour.default(Schedule[key]['hours_definitions'][i]['value']);
                                }
                            }
                        }
                        else{
                    ...
                    if(defaultAvailability === 'true') {
                        ...
                        if (DefaultSchedule !== undefined){
                            ...
                            if(DefaultSchedule['hours_definitions'] === null) {
                                DefaultSchedule['hours_definitions']= [];
                            }
                        ...
                        if ($('#DOPBSP-change-hours-definitions').is(':checked') 
                            ...
                            if (DefaultSchedule !== undefined){
//                                hoursValue = $('#DOPBSP-set-hours-default-data').is(':checked') ? hoursValue:DefaultSchedule['hours'];
                                hoursDefinitionsValue = DefaultSchedule['hours_definitions'];
                                statusValue = $('#DOPBSP-hours-status').val() !== undefined ? $('#DOPBSP-hours-status').val():$('#DOPBSP-status').val();
                            }
                            else{
                                hoursDefinitionsValue = HoursDefinitions;
                        ...
                        if(!HoursEnabled) {
                            available = $('#DOPBSP-available').val();
                        }
                        
                        delete hoursValue[undefined];
                        
                        DefaultSchedule = {"available": available,
                                         "bind": 0,
                                         "hours": $.extend(true, {}, hoursValue),
                                         "hours_definitions": hoursDefinitionsValue,
                                         "info": infoValue,
                    ...
                    for (i=0; i<hoursDefinitionsValue.length; i++){
                        ...
                        if (sHour+':'+sMinute <= key 
                            ...
                            Schedule[sYear+'-'+sMonth+'-'+sDay]['hours'][key] = {"available": availableValue,
                                                                                 ...
                                                                                 "promo": promoValue,
                                                                                 "status": statusValue};   
                            DefaultSchedule['hours'][key] = Schedule[sYear+'-'+sMonth+'-'+sDay];
                        }
                        
                        if(defaultAvailability === 'true') {
                            DefaultSchedule['status'] = $('#DOPBSP-hours-status').val();
                            DefaultSchedule['hours'][key] = {"available": availableValue,
                                                             "bind": bindValue,
                                                             "info": infoValue,
                                                             "notes": notesValue,
                                                             "price": priceValue,
             ...
             */
                ...
                if(defaultAvailability === 'true') {
                    methods_schedule.saveDefaultAvailability(DefaultSchedule);
                } else {
                ...
                if (confirm(ResetConfirmation)){
                    if (type === 'days'){
                        ...
                        for (i=0; i<Schedule[sYear+'-'+sMonth+'-'+sDay]['hours_definitions'].length; i++){
                            ...
                            if (sHour+':'+sMinute <= key 
                                    && key <= eHour+':'+eMinute){
                                Schedule[sYear+'-'+sMonth+'-'+sDay]['hours'][key] = methods_hour.default(key);
                            }
                        }
...
// Tooltip
        methods_tooltip = {
             ...
             */                         
                var info = infoData !== undefined ? infoData:(hour === '' ? (Schedule[day] !== undefined ? Schedule[day][type]:DefaultSchedule[type]):(Schedule[day] !== undefined && Schedule[day]['hours'][hour] ? Schedule[day]['hours'][hour][type]:DefaultSchedule['hours'][hour][type]));
