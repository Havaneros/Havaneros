    ...
    $.fn.DOPBSPCalendar = function(options){
        ...
        var Data = {"calendar": {"data": {"bookingStop": 0,
                    ...
                    "hours": {"data": {"addLastHourToTotalPrice": true,
                              ...
                              "text": {}},
                    "ID": 0,
                    "default_schedule": {"available":1,"bind":0,"hours":{},"hours_definitions":[{"value":"00:00"}],"info":"","notes":"","price":0,"promo":0,"status":"unavailable"},
                    "months": {"data": {"no": 1},
...
// 1. Main methods.
        ...
        methods = {
             ...
             */    
                ...
                ID = Data['ID'];
                default_schedule = JSON.parse(Data['default_schedule']);
...
// 6. Tooltip
        ...
        methods_tooltip = {
             ...
             */     
                var data = (hour === '' ? (methods_schedule.vars.schedule[day] !== undefined ? methods_schedule.vars.schedule[day]:default_schedule):
                                          (methods_schedule.vars.schedule[day] !== undefined ? methods_schedule.vars.schedule[day]['hours'][hour]:default_schedule[day]['hours'][hour])),
...
// 10. Days
        ...
        methods_days = {
             ...
             */
                ...
                if (methods_search.days.validate(ciDay) 
                    ...
                    if (schedule[selectedDays[0]] === undefined 
                        ...
                        if(default_schedule['status'] === 'unavailable' 
                          || default_schedule['status'] === 'booked') {
                    ...
                    if((schedule[selectedDays[0]] !== undefined
                       && schedule[selectedDays[noDays-1]] !== undefined)) {
                        ...
                        if ((schedule[selectedDays[0]]['bind'] !== undefined 
                             && schedule[selectedDays[noDays-1]]['bind'] !== undefined 
                                && schedule[selectedDays[0]]['bind'] === 2 
                                || schedule[selectedDays[0]]['bind'] === 3
                                || schedule[selectedDays[noDays-1]]['bind'] === 1 
                                || schedule[selectedDays[noDays-1]]['bind'] === 2)
                           || (default_schedule['bind'] !== undefined 
                                && default_schedule['bind'] === 2 
                                || default_schedule['bind'] === 3
                                || default_schedule['bind'] === 1 
                                || default_schedule['bind'] === 2)){
                ...
                if (methods_search.days.validate(ciDay) 
                    ...
                    for (i=0; i<selectedDays.length-(methods_days.data['morningCheckOut'] ? 1:0); i++){
                        ...
                        if (schedule[currDay] === undefined || 
                            ...
                            if(default_schedule === undefined) {
                                noAvailable = 1;
                            } else {
                                noAvailable = default_schedule['available'];
                            }
                        }
             ...
             */
                ...
                for (i=0; i<selectedDays.length-(methods_days.data['morningCheckOut'] ? 1:0); i++){
                    ...
                    } else if((default_schedule['status'] === 'available' 
                                || default_schedule['status'] === 'special')){
                        price = parseFloat(default_schedule['price']);
                        promo = parseFloat(default_schedule['promo']);
             ...
             */
                ...
                for (i=0; i<selectedDays.length-(methods_days.data['morningCheckOut'] ? 1:0); i++){
                    ...
                    if(schedule[currDay] === undefined) {
                        schedule[currDay] = default_schedule;
                    }
        ...
        methods_day = {
             ...
             */ 
                return {"available": default_schedule['available'],
                        "bind": 0,
                        "hours_definitions":  default_schedule['hours_definitions'],
                        "hours":  default_schedule['hours'],
                        "info":  default_schedule['info'],
                        "info_body": "",
                        "info_info": "",
                        "notes":  default_schedule['notes'],
                        "price":  default_schedule['price'], 
                        "promo":  default_schedule['promo'],
                        "status":  default_schedule['status']};
            },
            rp:function(){
            /*
...
// 11. Hours
        ...
        methods_hours = {
             ...
             */
                ...
                } else if(default_schedule !== undefined){
                    hoursDef = default_schedule['hours_definitions'];
                }                       
             ...
             */
                ...
                hours_definitions = schedule[day] !== undefined ? (schedule[day]['hours_definitions'] !== undefined ? schedule[day]['hours_definitions']:default_schedule['hours_definitions']):default_schedule['hours_definitions'];
             ...
             */
                ...
                if (methods_search.days.validate(day) 
                    ...
                    if ((schedule[day] !== undefined 
                            && (schedule[day]['hours'][selectedHours[0]] === undefined 
                            || schedule[day]['hours'][selectedHours[selectedHours.length-hoursDiff-1]] === undefined))
                       || (default_schedule['hours'] !== undefined
                           && default_schedule['hours'][selectedHours[0]] !== undefined)){
                        
                        if(default_schedule['hours'][selectedHours[0]]['status'] === 'unavailable' 
                          || default_schedule['hours'][selectedHours[0]]['status'] === 'booked') {
                            methods_info.toggleMessages(DOPBSPFrontEnd.text(ID, 'search', 'noServices'));
                            return false;
                        }
                    }
                    
                    if ((schedule[day] !== undefined && (schedule[day]['hours'][selectedHours[0]]['bind'] === 2 
                        ...
                        || (default_schedule['hours'][selectedHours[0]] !== undefined
                            && default_schedule['hours'][selectedHours[selectedHours.length-hoursDiff-1]] !== undefined
                            && (default_schedule['hours'][selectedHours[0]]['bind'] === 2 
                            || default_schedule['hours'][selectedHours[0]]['bind'] === 3 
                            || default_schedule['hours'][selectedHours[selectedHours.length-hoursDiff-1]]['bind'] === 1
                            || default_schedule['hours'][selectedHours[selectedHours.length-hoursDiff-1]]['bind'] === 2))){
                        methods_info.toggleMessages(DOPBSPFrontEnd.text(ID, 'search', 'noServicesSplitGroup'));
                        return false;
                    }
                    ...
                    for (i=0; i<selectedHours.length-hoursDiff; i++){
                        ...
                        if (schedule[day] !== undefined && (schedule[day]['hours'][currHour] !== undefined 
                            ...
                            hourFound = true;
                        } else if (default_schedule['hours'][currHour] !== undefined 
                                && (default_schedule['hours'][currHour]['status'] === 'available' 
                                        || default_schedule['hours'][currHour]['status'] === 'special')){
                            hourFound = true;
                        }

                        if (!hourFound){
                            
                            if(default_schedule['hours'][currHour]['status'] === 'unavailable' 
                                || default_schedule['hours'][currHour]['status'] === 'booked') {
                                methods_info.toggleMessages(DOPBSPFrontEnd.text(ID, 'search', 'noServices'));
                                return false;
                            }
                        }
                    ...
                    for (i=0; i<selectedHours.length-((!methods_hours.data['addLastHourToTotalPrice'] || methods_hours.data['interval']) && methods_hours.data['multipleSelect'] ? 1:0); i++){
                        ...
                        if (schedule[day] !== undefined
                            && schedule[day]['hours'][currHour] !== undefined 
                                && (schedule[day]['hours'][currHour]['status'] === 'available' 
                                        || schedule[day]['hours'][currHour]['status'] === 'special')
                           || (default_schedule['hours'][currHour] !== undefined 
                                && (default_schedule['hours'][currHour]['status'] === 'available' 
                                        || default_schedule['hours'][currHour]['status'] === 'special'))){
                            ...
                            if (schedule[day] !== undefined
                                ...
                                if(default_schedule === undefined
                                  || default_schedule['hours'][currHour] === undefined) {
                                    ...
                                    noAvailable = default_schedule['hours'][currHour]['available'];
                                }
                            } 
                            ...
                            if (schedule[day] === undefined){
                                ...
                                if(default_schedule['hours'][currHour] !== undefined
                                    && default_schedule !== undefined) {
                        ...
                        if((i+1)%2 !== 0) {
                            ...
                            if (schedule[day]['hours'][currHour] !== undefined 
                                ...
                                if (price !== 0){
                                    ...
                                    && (default_schedule['hours'][currHour]['status'] === 'available' 
                                            || default_schedule['hours'][currHour]['status'] === 'special')
                                    && (default_schedule['hours'][currHour]['bind'] === 0 
                                            || default_schedule['hours'][currHour]['bind'] === 1)){
                                price = parseFloat(default_schedule['hours'][currHour]['price']);
                                promo = parseFloat(default_schedule['hours'][currHour]['promo']);
             ...
             */
                ...
                for (i=0; i<selectedHours.length-((!methods_hours.data['addLastHourToTotalPrice'] || methods_hours.data['interval']) && methods_hours.data['multipleSelect'] ? 1:0); i++){
                    ...
                    history[currHour] = {"available": "",
                                         ...
                                         "promo": 0,
                                         "status": ""};
                    history[currHour]['available'] = schedule[day] !== undefined ? (schedule[day]['hours'][currHour] !== undefined ? schedule[day]['hours'][currHour]['available']:default_schedule['hours'][currHour]['available']):default_schedule['hours'][currHour]['available'];
                    history[currHour]['bind'] = schedule[day] !== undefined ? (schedule[day]['hours'][currHour] !== undefined ? schedule[day]['hours'][currHour]['bind']:default_schedule['hours'][currHour]['bind']):default_schedule['hours'][currHour]['bind'];
                    history[currHour]['price'] = schedule[day] !== undefined ? (schedule[day]['hours'][currHour] !== undefined ? schedule[day]['hours'][currHour]['price']:default_schedule['hours'][currHour]['price']):default_schedule['hours'][currHour]['price'];
                    history[currHour]['promo'] = schedule[day] !== undefined ? (schedule[day]['hours'][currHour] !== undefined ? schedule[day]['hours'][currHour]['promo']:default_schedule['hours'][currHour]['promo']):default_schedule['hours'][currHour]['promo'];
                    history[currHour]['status'] = schedule[day] !== undefined ? (schedule[day]['hours'][currHour] !== undefined ? schedule[day]['hours'][currHour]['status']:default_schedule['hours'][currHour]['status']):default_schedule['hours'][currHour]['status'];
                }
        ...
        methods_hour = {
             ...
             * @return JSON with default data
             */
                return {"available": default_schedule['hours'] !== undefined && default_schedule['hours'][hour] !== undefined ? default_schedule['hours'][hour]['available']:0, 
                        "bind": 0,
                        "info": default_schedule['hours'] !== undefined && default_schedule['hours'][hour] !== undefined ? default_schedule['hours'][hour]['info']:"", 
                        "info_body": default_schedule['hours'] !== undefined && default_schedule['hours'][hour] !== undefined ? default_schedule['hours'][hour]['info_body']:"",
                        "info_info": default_schedule['hours'] !== undefined && default_schedule['hours'][hour] !== undefined ? default_schedule['hours'][hour]['info_info']:"",
                        "notes": default_schedule['hours'] !== undefined && default_schedule['hours'][hour] !== undefined ? default_schedule['hours'][hour]['notes']:"",
                        "price": default_schedule['hours'] !== undefined && default_schedule['hours'][hour] !== undefined ? default_schedule['hours'][hour]['price']:0, 
                        "promo": default_schedule['hours'] !== undefined && default_schedule['hours'][hour] !== undefined ? default_schedule['hours'][hour]['promo']:0,
                        "status": default_schedule['hours'] !== undefined && default_schedule['hours'][hour] !== undefined ? default_schedule['hours'][hour]['status']:"none"};
            },
